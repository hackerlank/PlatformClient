...
public:
	...
	//是否字符消息
	virtual bool __cdecl IsStringMsg()=NULL;
	//获取时间
...
public:
	...
	//添加消息
	virtual bool __cdecl AddMsgItem(LPCTSTR lpszSendUser,LPCTSTR lpszMsg,COLORREF crColor,bool bMySelfString,BYTE bStringMsg)=NULL;
	//清除记录
