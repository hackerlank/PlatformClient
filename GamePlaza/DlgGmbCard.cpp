...
IMPLEMENT_DYNAMIC(CDlgGmbCard, CSkinDialog)
CDlgGmbCard::CDlgGmbCard(CWnd* pParent /*=NULL*/)
...
CDlgGmbCard::~CDlgGmbCard()
{
}

void CDlgGmbCard::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgGmbCard, CSkinDialog)
	//ON_WM_PAINT()
END_MESSAGE_MAP()


//配置消息
BOOL CDlgGmbCard::OnInitDialog()
{
...
//绘制消息
void CDlgGmbCard::OnDrawClientAreaEnd(CDC * pDC, INT nWidth, INT nHeight)
{
	//创建字体
	CFont DrawFont;
	DrawFont.CreateFont(-22,0,0,0,700,0,0,0,134,3,2,1,2,TEXT("宋体"));
	...
	pDC->TextOut(138,52,strCoordinate);
...
//随机函数
void CDlgGmbCard::RandCoordinate()
{
...
//设置密保
void CDlgGmbCard::SetMBCard(UINT uMBCardID)
{
