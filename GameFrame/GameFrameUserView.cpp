...
//广告偏移
#define	BILL_T						2									//广告上高
#define	BILL_L						6									//广告左宽
#define	BILL_R						2									//广告右宽
#define	BILL_B						130									//广告下高
...
BOOL CGameFrameUserView::OnEraseBkgnd(CDC * pDC)
{
	...
	if (m_pICurrentUserItem!=NULL)
	{
		...
		pUserItemElement->DrawExperience(pBufferDC,rcExperience.left+36,rcExperience.top-6L,dwExperience);
