...
VOID CParameterGlobal::LoadParameter()
{
	...
	{
		//界面配置
		m_cbLayoutMode=RegOptionItem.GetValue(TEXT("LayoutMode"),m_cbLayoutMode);
		m_bSalienceTable=RegOptionItem.GetValue(TEXT("SalienceTable"),m_bSalienceTable)?true:false;
		m_bHasLogonPlatform=RegOptionItem.GetValue(TEXT("HasLogonPlatform"),m_bHasLogonPlatform)?true:false;		
...
VOID CParameterGlobal::SaveParameter()
{
	...
	{
		//界面配置
		RegOptionItem.WriteValue(TEXT("LayoutMode"),m_cbLayoutMode);
		RegOptionItem.WriteValue(TEXT("SalienceTable"),m_bSalienceTable);
		RegOptionItem.WriteValue(TEXT("HasLogonPlatform"),m_bHasLogonPlatform);		
...
VOID CParameterGlobal::DefaultParameter()
{
	...
	m_bHasLogonPlatform=false;
	m_cbLayoutMode=LAYOUT_MODE_TREE;
